...
# gcloud storage
STORE_PATH=/mnt/project-prod-db-backup/elastic
STORE_LOG_PATH=/mnt/project-prod-db-backup/elastic/logs
...
echo $PRINT_LOG: ElasticSearch Backup Script Running... >> $LOG_PATH

check_gcs
backup_es

echo $PRINT_LOG: ElasticSearch Backup Script End >> $LOG_PATH
